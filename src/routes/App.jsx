    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          />
          <Route
            path="/proyectos/:projectId/trabajo"
            element={
              <PrivateRoute>
                <AuthenticatedLayout>
                  <Trabajo />
          ...
          />
          <Route
            path="/docente/proyectos/:projectId/trabajo"
            element={
              <PrivateRoute>
                <AuthenticatedLayout>
                  <Trabajo />
